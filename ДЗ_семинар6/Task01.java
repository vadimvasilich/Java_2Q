...
public class Task01 {
    ...
    public static int filterSecond(HashMap<Integer, String> hm, ArrayList<Laptop> al, HashMap<String, 
    ArrayList<String>> strMap, Scanner sc, int firstChoice) {
        int choice = -1;
    ...
    public static ArrayList<Laptop> getLaptopList() {
        ...
        Laptop macbook = new Laptop("Apple MacBook", "Silver", 8, 256, "MacOS");
        Laptop irbis = new Laptop("IRBIS NB80", "Black", 2, 32, "Windows 10 Home");
        Laptop hpLaptop = new Laptop("hp", "Dark gray", 16, 512, "FreeDOS");
        Laptop acer = new Laptop("Ноутбук Acer", "Black", 16, 512, "DOS");
